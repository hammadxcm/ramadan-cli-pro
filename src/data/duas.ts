...
export const GENERAL_DUAS: ReadonlyArray<Dua> = [
	...
	{
		day: 32,
		arabic: "اللهم إني أسألك في سفري هذا البر والتقوى",
		transliteration: "Allahumma inni as'aluka fi safari hadhal-birra wat-taqwa",
		translation: "O Allah, I ask You in this journey for righteousness and piety.",
		category: "travel",
	},
	// Eating
	{
		day: 33,
		arabic: "بسم الله وعلى بركة الله",
	...
	},
	{
		...
		translation:
			"O Allah, by You we enter morning, by You we enter evening, by You we live and by You we die.",
		category: "waking",
	},
	// Distress
	{
	...
	},
	{
		...
		translation: "O Living, O Sustainer, in Your mercy I seek relief.",
		category: "distress",
	},
	// Forgiveness
	{
		...
		transliteration: "Astaghfirullahul-ladhi la ilaha illa huwal-Hayyul-Qayyumu wa atubu ilayh",
		translation:
			"I seek forgiveness from Allah, there is no god but He, the Living, the Sustainer, and I turn to Him in repentance.",
	...
	},
	{
		...
		transliteration:
			"Rabbana dhalamna anfusana wa in lam taghfir lana wa tarhamna lanakunnana minal-khasirin",
		translation:
	...
	{
		day: 50,
		arabic: "أعوذ بالله العظيم وبوجهه الكريم وسلطانه القديم من الشيطان الرجيم",
		transliteration:
			"A'udhu billahil-'adhimi wa bi-wajhihil-karimi wa sultanihil-qadimi minash-shaytanir-rajim",
		translation:
	...
	},
	{
		...
		transliteration: "Allahumma aslih li diniyalladhi huwa 'ismatu amri",
		translation: "O Allah, set right for me my religion which is the safeguard of my affairs.",
		category: "general",
	},
	{
		day: 54,
		arabic: "اللهم إني أعوذ بك من شر ما عملت ومن شر ما لم أعمل",
	...
	{
		day: 55,
		arabic: "ربنا لا تؤاخذنا إن نسينا أو أخطأنا",
	...
	{
		day: 56,
		arabic: "ربنا هب لنا من أزواجنا وذرياتنا قرة أعين",
	...
	{
		day: 58,
		arabic: "ربنا لا تزغ قلوبنا بعد إذ هديتنا",
